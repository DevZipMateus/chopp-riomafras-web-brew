        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-foreground mb-2">Horário de funcionamento</h3>
                <p className="text-muted-foreground">
            ...
            <div className="pt-6">
              <Button
                asChild
                size="lg"
                className="w-full bg-primary text-primary-foreground hover:bg-accent hover:text-accent-foreground shadow-gold"
              >
          ...
          <div className="animate-fade-in">
            <div className="bg-muted/30 rounded-lg overflow-hidden h-full min-h-[500px]">
              <iframe
