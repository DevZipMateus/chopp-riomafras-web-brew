...
const Hero = () => {
  return <section id="hero" className="pt-32 pb-20 min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <h2 className="text-xl md:text-2xl mb-8 max-w-2xl leading-relaxed text-zinc-950">
            Distribuindo sabores, conectando pessoas e celebrando histórias
          </h2>
          
          <p className="text-lg md:text-xl mb-10 max-w-3xl text-neutral-950">
            Chopp de alta qualidade com delivery em Mafra, Itaiópolis, Rio Negro, Campo do Tenente e região
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center w-full sm:w-auto">
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-accent hover:text-accent-foreground shadow-gold text-lg px-8 py-6">
            ...
            <Button asChild variant="outline" size="lg" className="bg-background/80 text-foreground border-primary/60 hover:bg-secondary hover:text-secondary-foreground hover:border-secondary text-lg px-8 py-6">
              <a href="#servicos">
                Ver serviços
              </a>
            </Button>
